...
submit1:function()
{
  ...
  {
    return({To:"msg",Subject:"hi",Message:"yuuu"});
  },
    ...
    <form  className="form-horizontal">
      <div className="form-group">
        <div className="col-lg-12">
          <input className="form-control" id="To"  placeholder="To" type="email" onChange={this.sending}/>
        </div>
      </div>
      <div className="form-group">
        <div className="col-lg-12">
          <input className="form-control" id="Subject"  placeholder="Subject" type="text" onChange={this.sending}/>
        </div>
      </div>
      <div className="form-group">
        <div className="col-lg-12" >
