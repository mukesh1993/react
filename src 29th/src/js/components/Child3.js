...
<div className="container-fluid">
    ...
    {this.props.mailFrom}
      ...
      {this.state.status?<Modalwindow1 j1={this.change2} a={this.props.mailFrom} b={this.props.mailSubject} c={this.props.mailDate} d={this.props.encodedBodyToChild}/>:null}
		</div>
