    ...
    <form  className="form-horizontal">
      <div className="form-group">
        <div className="col-lg-12">
          <input className="form-control"  id="To" placeholder="To" type="email" value={this.props.j} onChange={this.sending}/>
        </div>
      </div>
      <div className="form-group">
        <div className="col-lg-12">
          <input className="form-control" id="Subject"  placeholder="Subject" type="text"value={this.props.k} onChange={this.sending}/>
        </div>
      </div>
      <div className="form-group">
        <div className="col-lg-12" >
