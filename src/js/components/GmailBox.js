...
var GmailBox = React.createClass({
  ...
  getmsgIDS: function()
  {
    var accessToken = localStorage.getItem('gToken');
    $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/mukeshkommuri123%40gmail.com/messages?labelIds=INBOX&maxResults=10&key={AIzaSyAnWPi_H4F191snt0wE8UnM23-q-BXqeyM}',
      dataType: 'json',
      type: 'GET',
      async:false,
      beforeSend: function (request)
